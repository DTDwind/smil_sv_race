...
def ComputeMinDcf(fnrs, fprs, thresholds, p_target, c_miss, c_fa):
    ...
    '''
    c_def ->(4) c_miss * p_target=1*0.05=0.05 ; c_fa * (1 - p_target)=1*(1-0.05)=0.05 取小值:0.05  
    '''
    c_def = min(c_miss * p_target, c_fa * (1 - p_target)) 
    min_dcf = min_c_det / c_def #->(3) normalize過後
...
def main():
    ...
    for line in trials_file:
        ...
        or {0 : voxceleb1/id10136/kDIpLcekk9Q/00011.wav voxceleb1/id10136/kTkrpBqwqJs/00001.wav}
        '''
    ...
    fnrs, fprs, thresholds = ComputeErrorRates(scores, labels) #fnrs->False negative rate ; fprs->False positive rate
    '''
    fnrs:False negative rate 語音未包含，系統卻識別出來
    fprs:False positive rate 語音有包含，系統卻未識別出來
    '''
