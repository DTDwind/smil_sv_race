...
class score_merge():
    def __init__(self):
        ...
        self.start = 80000 # 這裡開始
        self.end   = 118438  # 這裡結束


        self.n_top = 100
        self.score_dir = '/home/chengsam/esp2080_test_score/'
        ...
        self.merge_path = '/home/chengsam/Thread_fast_esp2080_top_100_merge_80000_118438/'
